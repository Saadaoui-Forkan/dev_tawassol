  ...
  return (
    <div className="mt-16">
      {/* 
        ...
        <p className='text-lg text-zinc-800 my-4'>You have not yet setup a profile, please add some info.</p>
        <Button>
      ...
      */}
      ...
      <div className="add-experience">
        <h2 className="mx-4 mt-6 p-4 font-bold border-b-2 border-zinc-600 text-zinc-600">Experience Credentials</h2>
        {/* Experience Table */}
      ...
      <div className="add-education">
        <h2 className="mx-4 mt-6 p-4 font-bold border-b-2 border-zinc-600 text-zinc-600">Education Credentials</h2>
        {/* Education Table */}
        <div className="flex flex-col">
          <div className="overflow-x-auto sm:mx-0.5 lg:mx-0.5">
            <div className="py-2 inline-block min-w-full sm:px-6 lg:px-8">
